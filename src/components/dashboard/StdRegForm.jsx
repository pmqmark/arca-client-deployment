...
import { Address, FormData, Office } from "../../data/Dashboard";
...
const StdRegForm = ({ setModal, entity }) => {
                    ...
                    <form action="" onSubmit={submitHandler}>
                        <div className="w-full flex flex-wrap">
                            <>
                                ...
                                {Address.map((data) => (
                                    <div key={data?.id} className="w-full md:w-1/2 p-1 py-2">
                                        <Input
                                            ...
                                            type={data?.type}
                                            changeHandler={changeHandler}
                                            value={formData?.address?.[data?.name]}
                                        />
                                    </div>
                                ))}
                                ...
                                {
                                    <select
                                        className={`border border-primary_colors/50 text-gray-400 text-xs p-3 focus:outline-none w-full sm:w-1/2 rounded-lg`}
                                        name="office"
                                        id=""
